...
def get_cutoff_indices_features_and_target(
    ...
    step_size: int
        ...
        # It's -1 due to the len being 744 but the index 743 due to start from 0 index count
        # len(ts_data_one_location) #744
        # ts_data_one_location.tail() #743
        
        # Start the first sub-sequence at index position 0
        subseq_first_idx = 0

        # See visual above to understand that n_features is size of sliding window used
        # until we want to predict the target 
